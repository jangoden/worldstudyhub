...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: blog.title,
    description: blog.paragraph.substring(0, 150) + "...",
  };
}
                  ...
                  <div className="flex flex-wrap items-center">
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        ...
                        <span className="text-body-color block text-xs">
                    ...
                    <div className="mb-5 flex items-center">
                      ...
                      <p className="text-body-color mr-5 flex items-center text-base font-medium">
                        ...
                        {/* Comments count, not available from API yet */}
                        0
                      </p>
                      <p className="text-body-color flex items-center text-base font-medium">
                        ...
                        {/* Views count, not available from API yet */}
                        0
                      </p>
                    </div>
                  </div>
